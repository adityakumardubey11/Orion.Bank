...
//   }
  ...
  return (
    <>
          <div className="min-h-[80vh] flex items-center justify-center bg-amber-950">
       
                    <div className="w-full xl:w-[60%] flex items-start border">
                       <div className="hidden lg:block bg-amber-950">
                          <img src="/orion2.jpg" className="h-full w-full object-cover" alt="Orion" />
                            </div>
...
<ErrorMessage name='email' className='text-blue-600' component={'p'} />

</div>
<div className="mb-3">
<Field type="text" name='password'  className="w-full py-3 px-3 rounded border outline-none  placeholder-white text-white" placeholder="Enter Your Password" />
<ErrorMessage name='password' className='text-blue-600' component={'p'} />
...
<div className="mb-3">
<p className='text-end font-medium text-white drop-shadow-md'>Don't Have An Account ? <Link href={'/register'} className='text-blue-600 '>Register</Link> </p>
</div>
</Form>
          </Formik>
                    </div>
          ...
          <div className="relative min-h-screen flex flex-col items-center justify-center bg-gradient-to-r from-amber-950 to-amber-700 text-white text-center p-4 overflow-hidden">
  ...
  <div className="mt-10 max-w-2xl text-left bg-amber-950 bg-opacity-20 backdrop-blur-md rounded-xl p-6 space-y-3 animate-slideUp">
    <p className="font-semibold text-yellow-200">🔒 General Security Reminder:</p>
    ...
    <p className="font-semibold text-yellow-200 mt-4">⚠️ Login Warning / Caution:</p>
    <ul className="list-disc list-inside text-sm text-white">
    ...
    <p className="font-semibold text-yellow-200 mt-4">🔑 Password / OTP Guidance:</p>
    <ul className="list-disc list-inside text-sm text-white">
    ...
    <p className="font-semibold text-yellow-200 mt-4">💻 Device/Session Reminder:</p>
    <ul className="list-disc list-inside text-sm text-white">
      <li>Do not use public devices to access your account.</li>
      <li>Always log out after using Orion Bank on shared devices.</li>
    </ul>

    <p className="font-semibold text-yellow-200 mt-4">⚖️ Legal / Disclaimer:</p>
    <ul className="list-disc list-inside text-sm text-white">
