  ...
  return (
    <> 
        <button
          type="button"
          onClick={openModal}
          className="rounded-md w-1/2 px-6 py-2 bg-violet-800 text-white flex items-center justify-center gap-x-2 outline-none border-none cursor-pointer"
        >
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-lg transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  <Dialog.Title
                    as="div"
                    className="text-lg font-medium leading-6 text-violet-600 flex items-center justify-between"
                  >
                 <h3>   Add New ATM </h3>
                 <button onClick={closeModal} className='p-2 text-2xl text-white bg-violet-500 rounded-full outline-none border-none cursor-pointer'>
                  <IoClose/>
                 </button>
                          ...
                          {({values,handleSubmit})=>(
                                  <form onSubmit={handleSubmit} className='py-4'>
                                    <div className="mb-3 text-white" >
                                      ...
                                      <Field name="account" id="account" as="select" className="w-full py-2 border border-violet-500 rounded outline-none px-2 text-black">
                                      {
                  ...
                  <option value="">No Account Have</option>
                                    ...
                                    <label htmlFor="card_type">Card Type</label>
                                        <Field as="select" className="w-full py-2 border border-violet-500 rounded outline-none px-2"  name="card_type" id="card_type">
                                        {
                 ...
                 <div className="mb-3">
                  ...
                  <Field type="text" id="pin" name="pin" className="w-full py-2 px-3 rounded-md border outline-none border-violet-500" placeholder='PIN Number' onInput={(e)=>{
